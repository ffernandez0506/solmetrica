...
END
GO
CREATE PROCEDURE INSERT_BANCO (@direccion varchar(50), @nombre varchar(50))
AS
BEGIN
 INSERT INTO BANCO ([Direccion],[FechaRegistro],[Nombre])
 VALUES (@direccion,GETDATE(),@nombre)
END
GO
CREATE PROCEDURE UPDATE_BANCO (@idBanco int, @direccion varchar(50), @nombre varchar(50))
AS
BEGIN
UPDATE banco
set 
...
END
GO
CREATE PROCEDURE INSERT_SUCURSAL(@direccion varchar(50), @nombre varchar(50),@idBanco int)
AS
BEGIN
 INSERT INTO [Sucursal] ([Direccion],[FechaRegistro],[Nombre],[IdBanco])
 VALUES (@direccion,GETDATE(),@nombre,@idBanco)
END
GO
CREATE PROCEDURE UPDATE_SUCURSAL(@idSucursal int, @direccion varchar(50), @nombre varchar(50))
AS
BEGIN
UPDATE [Sucursal]
SET 
